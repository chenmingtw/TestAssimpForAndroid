...
Java_com_example_testassimpforandroid_AssimpActivity_CreateObjectNative(JNIEnv *env,
                                                                         jobject instance,
...
JNIEXPORT void JNICALL
Java_com_example_testassimpforandroid_AssimpActivity_DeleteObjectNative(JNIEnv *env,
                                                                         jobject instance) {
