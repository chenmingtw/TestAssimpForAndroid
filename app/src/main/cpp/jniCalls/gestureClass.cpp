...
Java_com_example_testassimpforandroid_GestureClass_DoubleTapNative(JNIEnv *env, jobject instance) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_testassimpforandroid_GestureClass_ScrollNative(JNIEnv *env, jobject instance,
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_testassimpforandroid_GestureClass_ScaleNative(JNIEnv *env, jobject instance,
                                                              jfloat scaleFactor) {
 ...
 */
JNIEXPORT void JNICALL
Java_com_example_testassimpforandroid_GestureClass_MoveNative(JNIEnv *env, jobject instance,
                                                               jfloat distanceX, jfloat distanceY) {
